...
#     This exciting event starts on #{format_datetime(event.start_date)}
#     and runs until #{format_datetime(event.end_date)}.
#     #{event.description || "Don't miss this amazing opportunity!"}

#     Key highlights include networking sessions, expert talks, and hands-on workshops.
#     Perfect for professionals looking to expand their knowledge and connect with like-minded individuals.

#     Ready to experience #{event.title}? Register now to secure your spot and be part of this unforgettable event!
#     """
